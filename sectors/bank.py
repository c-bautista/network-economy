...
class BankSector:
    ...
    def compute_profit_and_bad_debt(self, DB_connection=None, UB_connection=None,
                                    D_bank_interest_rate=None, U_bank_interest_rate=None,
                                    D_bank_credit=None, U_bank_credit=None,
        ...
        np.add.at(self.B_U, UB_connection, U_bank_interest_rate * U_bank_credit)
